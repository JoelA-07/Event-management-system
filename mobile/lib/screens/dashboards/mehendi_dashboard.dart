...
import '../mehendi_services_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            const DashboardHeader(subTitle: "MEHENDI ARTIST STUDIO"),
            Padding(
              padding: const EdgeInsets.all(20),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text("Artist Management", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 15),
                  _buildActionCard(
                    context,
                    "Manage Designs",
                    "Upload new mehendi styles",
                    Icons.brush,
