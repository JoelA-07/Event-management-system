...
class PhotographerServiceFormScreen extends StatefulWidget {
  ...
  const PhotographerServiceFormScreen({super.key, this.existing});

  @override
  State<PhotographerServiceFormScreen> createState() => _PhotographerServiceFormScreenState();
}

class _PhotographerServiceFormScreenState extends State<PhotographerServiceFormScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(widget.existing == null ? "New Photography Package" : "Edit Photography Package")),
