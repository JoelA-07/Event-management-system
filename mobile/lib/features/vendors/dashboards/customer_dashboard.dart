...
import 'package:mobile/core/event_types.dart';
...
import 'package:mobile/features/ai/screens/chatbot_screen.dart';
...
import 'package:mobile/features/vendors/screens/vendor_list_screen.dart';
import 'package:mobile/features/vendors/screens/sample_checkout_screen.dart';
import 'package:mobile/features/halls/screens/event_results_screen.dart';
    ...
    return SingleChildScrollView(
      ...
      child: Row(
        children: [
          ...
          _catItem(Icons.back_hand, "Mehendi", () => Navigator.push(context, MaterialPageRoute(builder: (_) => const VendorListScreen(category: 'mehendi')))),
        ],
      ),
    );
  }
