...
router.post('/add-with-image', requireRole(['photographer', 'caterer', 'designer', 'mehendi', 'decorator', 'organizer']), uploadSingle, addServiceWithImage);
router.put('/:id', requireRole(['photographer', 'caterer', 'designer', 'mehendi', 'decorator', 'organizer']), uploadSingle, updateService);
router.post('/:id/images', requireRole(['photographer', 'caterer', 'designer', 'mehendi', 'decorator', 'organizer']), uploadMultiple, addServiceImages);
router.delete('/:id/images', requireRole(['photographer', 'caterer', 'designer', 'mehendi', 'decorator', 'organizer']), removeServiceImage);
router.post('/add-menu', requireRole(['caterer', 'organizer']), addMenu);
router.post('/add-menu-with-image', requireRole(['caterer', 'organizer']), uploadSingle, addMenuWithImage);
...
router.put('/menu/:id', requireRole(['caterer', 'organizer']), uploadSingle, updateMenu);
